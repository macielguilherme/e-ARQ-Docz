...
cruzamentoRequisitos2["2.1.8"] = criarRequisito(
    ...
    "Num SIGAD, o número identificador atribuído pelo sistema tem que:\n• ser gerado automaticamente, sendo vedada sua introdução manual e alteração posterior;\n• ou ser atribuído pelo usuário e validado pelo SIGAD antes de ser aceito.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "2",
...
cruzamentoRequisitos2["2.1.16"] = criarRequisito(
    ...
    "Sempre que um documento tiver mais de uma versão, o SIGAD tem que permitir que os usuários selecionem pelo menos uma das seguintes ações:\n• registrar todas as versões do documento como um só documento arquivístico;\n• registrar uma única versão do documento como um documento arquivístico;\n• registrar cada uma das versões do documento, separadamente, como um documento arquivístico. Um SIGAD não deve considerar minutas como versão. Cada versão deve ser dotada de completeza.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "2",
...
cruzamentoRequisitos2["2.1.17"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD preste assistência aos usuários no que diz respeito à classificação dos documentos, por meio de algumas ou de todas as ações a seguir:\n• tornar acessível ao usuário somente o subconjunto do plano de classificação que diz respeito à sua atividade;\n• indicar as últimas classificações feitas pelo usuário;\n• indicar dossiês que contenham documentos de arquivo relacionados;\n• indicar classificações possíveis a partir dos metadados já inseridos, como, por exemplo, o título;\n• indicar classificações possíveis a partir do conteúdo do documento.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Desejável",
    "2",
...
cruzamentoRequisitos2["2.6.1"] = criarRequisito(
    ...
    "Em caso do SIGAD apoiar a produção de documentos, ele tem que ser capaz de reconhecer três domínios para o controle dos procedimentos de gestão:\n• espaço individual,\n• espaço do grupo e\n• espaço geral.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "2",
...
cruzamentoRequisitos2["3.3.4"] = criarRequisito(
    ...
    "Um SIGAD tem que avisar ao usuário autorizado quando um documento ou dossiê/processo que estiver sendo eliminado se encontrar relacionado a outro; os sistemas também têm de suspender o processo até que seja tomada uma das medidas abaixo:\n• confirmação pelo usuário autorizado para prosseguir;\n• ou cancelar o processo;\n• produção de um relatório especificando os documentos ou dossiês/processos envolvidos e todas as ligações com outros documentos ou dossiês/processos.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "3",
...
cruzamentoRequisitos2["4.3.5"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD permita a configuração do formato da lista de resultados de pesquisa pelo usuário ou administrador, incluindo recursos e funções como:\n• seleção da ordem em que os resultados de pesquisa são apresentados;\n• determinação do número de resultados de pesquisa exibidos em cada tela;\n• estabelecimento do número máximo de resultados para uma pesquisa;\n• armazenamento dos resultados de uma pesquisa;\n• definição dos metadados a serem exibidos nas listas de resultados de pesquisa.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Desejável",
    "4",
...
cruzamentoRequisitos2["4.3.6"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD forneça recursos que permitam ao usuário 'navegar' para o nível de agregação imediatamente superior ou inferior, como, por exemplo:\n• de um documento para a unidade de arquivamento em que está incluído;\n• de uma unidade de arquivamento para os documentos nela incluídos;\n• de uma unidade de arquivamento para a respectiva classe;\n• de uma classe para as unidades de arquivamento a ela relacionadas.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Desejável",
    "4",
...
cruzamentoRequisitos2["4.3.7"] = criarRequisito(
    ...
    "Um SIGAD tem que ser capaz de apresentar o conteúdo de todos os documentos arquivísticos digitais definidos pelo programa de gestão de documentos, de forma que:\n• preserve as características de exibição visual e de formato apresentados pela aplicação geradora;\n• exiba todos os componentes do documento digital em conjunto, como uma unidade. No caso de necessidade de captura de documentos em formatos de arquivo não previstos no programa de gestão de documentos, o SIGAD tem que permitir o download do documento para que possa ser visualizado em outro ambiente.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "4",
...
cruzamentoRequisitos2["4.3.17"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD seja capaz de apresentar os documentos arquivísticos em outros formatos além do nativo, tais como:\n• formato .xml adequado para publicação;\n• formato .html adequado para publicação;\n• formato aprovado por organismos padronizadores na sua esfera de competência.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Desejável",
    "4",
...
cruzamentoRequisitos2["6.1.17"] = criarRequisito(
    ...
    "Sempre que o participante for um grupo de trabalho, é altamente desejável que um recurso de fluxo de trabalho de um SIGAD preveja a forma de distribuição dos documentos entre os membros do grupo. Essa distribuição pode ser de duas formas:\n• de acordo com uma sequência circular predefinida, o SIGAD envia o próximo documento independentemente da conclusão da tarefa anterior;\n• ou à medida que cada membro conclui a tarefa, o SIGAD lhe envia o próximo documento da fila do grupo.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Desejável",
    "6",
...
cruzamentoRequisitos2["7.3.3"] = criarRequisito(
    ...
    "Um SIGAD tem que tratar a classificação de grau de sigilo baseando-se nos seguintes atributos de segurança:\n• grau de sigilo do documento;\n• credencial de segurança do usuário;\n• identificação da autoridade classificadora. O grau de sigilo tem que estar associado à credencial de segurança. Incluem-se também os documentos recebidos com classificação de grau de sigilo.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "7",
...
cruzamentoRequisitos2["7.3.9"] = criarRequisito(
    ...
    "Um SIGAD tem que permitir que um dos itens abaixo seja selecionado durante a configuração:\n• graus de sigilo e restrições de acesso a serem atribuídos a classes e dossiês/processos;\n• classes e dossiês/processos sem grau de sigilo ou outras restrições de acesso.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "7",
...
cruzamentoRequisitos2["7.4.12"] = criarRequisito(
    ...
    "Um SIGAD tem que fornecer relatórios sobre as ações que afetam classes, unidades de arquivamento e documentos, em ordem cronológica e organizados por:\n• documento arquivístico, unidade de arquivamento ou classe;\n• usuário;\n• tipo de ação ou operação.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "7",
...
cruzamentoRequisitos2["7.5.4"] = criarRequisito(
    ...
    "Um SIGAD, no processo de verificação da assinatura digital, tem que ser capaz de registrar, como metadado, o seguinte:\n• validade da assinatura verificada;\n• registro da verificação da assinatura;\n• data e hora em que ocorreu a verificação.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "Facultativo",
    "7",
...
cruzamentoRequisitos2["7.11.7"] = criarRequisito(
    ...
    "Um SIGAD tem que preservar um estado seguro de funcionamento, interrompendo completamente a interação com usuários comuns, quando ocorrer um dos erros a seguir:\n• falha de comunicação entre cliente e servidor;\n• perda de integridade das informações de controle de acesso;\n• falta de espaço para registro nas trilhas de auditoria.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "Facultativo",
    "7",
...
cruzamentoRequisitos2["7.12.6"] = criarRequisito(
    ...
    "Se o SIGAD não fornecer, diretamente, esses recursos, tem que permitir que outros pacotes de software os proporcionem. Um SIGAD tem que possibilitar a ocultação de informação sigilosa contida no documento original, permitindo:\n• retirada de páginas de um documento;\n• adição de retângulos opacos para ocultar nomes ou palavras sensíveis;\n• quaisquer outros recursos necessários para formatos de vídeo ou áudio, caso existam.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "7",
...
cruzamentoRequisitos2["8.2.5"] = criarRequisito(
    "8.2.5",
...
cruzamentoRequisitos2["8.2.6"] = criarRequisito(
    "8.2.6",
...
cruzamentoRequisitos2["8.2.7"] = criarRequisito(
    "8.2.7",
    "Ações de preservação ante obsolescência",
    "Ações de preservação têm que ser efetivadas sempre que se torne patente ou previsível a obsolescência da tecnologia utilizada pelo SIGAD.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "8",
...
cruzamentoRequisitos2["8.2.8"] = criarRequisito(
    "8.2.8",
    "Transferência em bloco de documentos",
    "Um SIGAD tem que suportar a transferência em bloco de documentos (incluindo as demais informações associadas a cada documento) para outros suportes e/ou sistemas, de acordo com as normas aplicáveis aos formatos utilizados.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "8",
...
// ============================================================
// Seção 8.3 - Aspectos gerais da preservação
// ============================================================

cruzamentoRequisitos2["8.3.2"] = criarRequisito(
    "8.3.2",
...
cruzamentoRequisitos2["8.3.3"] = criarRequisito(
    "8.3.3",
    "Verificação de modificações em ambiente exclusivo",
    "As modificações em um SIGAD e em sua base tecnológica têm que ser verificadas num ambiente exclusivo para essa finalidade, de modo a garantir que, após a implantação das alterações, os dados continuem sendo acessados sem alteração de conteúdo.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "8",
...
cruzamentoRequisitos2["8.3.4"] = criarRequisito(
    "8.3.4",
...
cruzamentoRequisitos2["8.3.5"] = criarRequisito(
    "8.3.5",
...
// ============================================================
// CAPÍTULO 9 - ARMAZENAMENTO - REQUISITOS NÃO FUNCIONAIS
// Seção 9.1 - Durabilidade
// ============================================================

cruzamentoRequisitos2["9.1.1"] = criarRequisito(
    "9.1.1",
...
cruzamentoRequisitos2["9.1.2"] = criarRequisito(
    "9.1.2",
    "Revisão da escolha de dispositivos",
    "A escolha de dispositivos tem que ser revista sempre que a evolução tecnológica indicar mudanças importantes.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "9",
...
cruzamentoRequisitos2["9.1.3"] = criarRequisito(
    "9.1.3",
    "Migração preventiva ante obsolescência",
    "Atividades de migração têm que ser efetivadas, preventivamente, sempre que se torne patente ou previsível a obsolescência do padrão corrente.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "9",
...
cruzamentoRequisitos2["9.1.4"] = criarRequisito(
    "9.1.4",
    "Registro de MTBF e data de aquisição",
    "Para as memórias secundárias, um SIGAD tem que manter registro de MTBF (mean time between failure), bem como suas datas de aquisição.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "9",
...
cruzamentoRequisitos2["9.1.6"] = criarRequisito(
    "9.1.6",
...
cruzamentoRequisitos2["9.1.7"] = criarRequisito(
    "9.1.7",
...
cruzamentoRequisitos2["9.2.3"] = criarRequisito(
    "9.2.3",
...
cruzamentoRequisitos2["9.2.4"] = criarRequisito(
    "9.2.4",
...
cruzamentoRequisitos2["9.2.5"] = criarRequisito(
    "9.2.5",
...
cruzamentoRequisitos2["9.2.6"] = criarRequisito(
    "9.2.6",
...
cruzamentoRequisitos2["9.3.1"] = criarRequisito(
    "9.3.1",
...
cruzamentoRequisitos2["9.3.4"] = criarRequisito(
    "9.3.4",
...
cruzamentoRequisitos2["9.3.5"] = criarRequisito(
    "9.3.5",
    "Verificação periódica da integridade dos dispositivos",
    "A integridade dos dispositivos de armazenamento tem que ser, periodicamente, verificada.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "9",
...
// ============================================================
// CAPÍTULO 11 - CONFORMIDADE COM A LEGISLAÇÃO
// ============================================================

cruzamentoRequisitos2["11.3"] = criarRequisito(
    "11.3",
    "Conformidade com requisitos regulamentares específicos",
    "Um SIGAD tem que estar em conformidade com requisitos regulamentares específicos e códigos de boa prática necessários para a execução de determinadas atividades. Este requisito pode ser personalizado para cada contexto, como, por exemplo, saúde, justiça, educação, previdência.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "11",
...
cruzamentoRequisitos2["12.1.2"] = criarRequisito(
    "12.1.2",
...
cruzamentoRequisitos2["12.1.3"] = criarRequisito(
    "12.1.3",
...
cruzamentoRequisitos2["12.1.4"] = criarRequisito(
    "12.1.4",
...
cruzamentoRequisitos2["12.1.5"] = criarRequisito(
    "12.1.5",
...
cruzamentoRequisitos2["12.1.6"] = criarRequisito(
    "12.1.6",
...
cruzamentoRequisitos2["12.1.7"] = criarRequisito(
    "12.1.7",
...
cruzamentoRequisitos2["12.1.8"] = criarRequisito(
    "12.1.8",
...
cruzamentoRequisitos2["12.1.9"] = criarRequisito(
    "12.1.9",
...
cruzamentoRequisitos2["12.1.10"] = criarRequisito(
    "12.1.10",
...
cruzamentoRequisitos2["12.1.11"] = criarRequisito(
    "12.1.11",
...
cruzamentoRequisitos2["12.1.12"] = criarRequisito(
    "12.1.12",
...
cruzamentoRequisitos2["12.1.13"] = criarRequisito(
    "12.1.13",
...
cruzamentoRequisitos2["12.1.14"] = criarRequisito(
    "12.1.14",
...
cruzamentoRequisitos2["12.1.16"] = criarRequisito(
    "12.1.16",
...
cruzamentoRequisitos2["12.1.17"] = criarRequisito(
    "12.1.17",
...
cruzamentoRequisitos2["12.1.18"] = criarRequisito(
    "12.1.18",
...
cruzamentoRequisitos2["12.1.19"] = criarRequisito(
    "12.1.19",
...
cruzamentoRequisitos2["12.1.20"] = criarRequisito(
    "12.1.20",
...
cruzamentoRequisitos2["12.1.21"] = criarRequisito(
    "12.1.21",
...
cruzamentoRequisitos2["12.1.22"] = criarRequisito(
    "12.1.22",
...
cruzamentoRequisitos2["12.1.23"] = criarRequisito(
    "12.1.23",
...
cruzamentoRequisitos2["12.1.25"] = criarRequisito(
    "12.1.25",
...
cruzamentoRequisitos2["15.1.1"] = criarRequisito(
    "15.1.1",
...
cruzamentoRequisitos2["15.1.2"] = criarRequisito(
    "15.1.2",
...
cruzamentoRequisitos2["15.1.3"] = criarRequisito(
    "15.1.3",
    "Rotinas de manutenção",
    "Um SIGAD tem que incluir rotina de manutenção de:\n• dados de usuários e de grupos;\n• perfis de acesso;\n• plano de classificação;\n• bases de dados;\n• tabelas de temporalidade. Essas tarefas devem atender às mudanças planejadas da organização, sem causar grande sobrecarga de administração.",
    "VERIFICAR!!",
    "Pendente de verificação.",
    "e-ARQ Obrigatório",
    "15",
...
function getRequisitosPorStatus(status) {
    return Object.values(cruzamentoRequisitos2).filter(r => r.status === status);
}

function getRequisitosPorGrupo(grupo) {
    return Object.values(cruzamentoRequisitos2).filter(r => r.grupo === grupo);
}

function getRequisitosPorCapitulo(capitulo) {
    return Object.values(cruzamentoRequisitos2).filter(r => r.capitulo === capitulo);
}

function getRequisitosPorSecao(secao) {
    return Object.values(cruzamentoRequisitos2).filter(r => r.secao === secao);
}

function getEstatisticas() {
    const total = Object.keys(cruzamentoRequisitos2).length;
...
function getBugsAbertos() {
    const bugs = [];
    Object.values(cruzamentoRequisitos2).forEach(req => {
...
function getRequisitosNaoAtendidos() {
    return Object.values(cruzamentoRequisitos2).filter(r =>
...
function getResumoPorGrupo() {
    const grupos = {};
    Object.values(cruzamentoRequisitos2).forEach(r => {
        if (!grupos[r.grupo]) {
