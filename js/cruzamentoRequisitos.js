...
// ============================================================
// Organização dos documentos arquivísticos - PLANO DE CLASSIFICAÇÃO
// ============================================================
...
cruzamentoRequisitos["1.1.1"] = criarRequisito(
    ...
    "Um SIGAD tem que incluir e ser compatível com o plano de classificação do órgão ou entidade, com as seguintes informações:\n• identificador da classe;\n• nome da classe;\n• código da classe;\n• subordinação da classe;\n• indicação de permissão de uso;\n• indicação de classe ativa/inativa. O plano de classificação dos integrantes do SINAR deve estar de acordo com a legislação e ser aprovado pela instituição arquivística na esfera de competência específica.",
    "Atendido",
...
cruzamentoRequisitos["1.1.16"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD seja capaz de importar e exportar, total ou parcialmente, um plano de classificação. Ver Organização dos documentos arquivísticos3 – Interoperabilidade",
    "Atendido",
...
cruzamentoRequisitos["1.2.2"] = criarRequisito(
    ...
    "Um SIGAD tem que manter tabela de temporalidade e destinação de documentos com as seguintes informações:\n• identificador da classe;\n• prazo de guarda na idade corrente;\n• evento que determina o início de contagem do prazo de retenção na idade corrente;\n• prazo de guarda na idade intermediária;\n• evento que determina o início de contagem do prazo de retenção na idade intermediária;\n• destinação final;\n• sigilo associado à classe;\n• observações. A tabela de temporalidade e destinação de documentos dos integrantes do SINAR deve estar de acordo com a legislação e ser aprovada pela instituição arquivística na específica esfera de competência.",
    "Atendido",
...
cruzamentoRequisitos["1.2.4"] = criarRequisito(
    ...
    "Um SIGAD tem que prever a iniciação automática da contagem dos prazos de guarda referenciados na tabela de temporalidade e destinação de documentos, pelo menos, a partir dos seguintes eventos:\n• abertura de dossiê/processo;\n• arquivamento de dossiê/processo;\n• desarquivamento de dossiê/processo;\n• inclusão de documento sigiloso em um dossiê/processo, se aplicável. Acontecimentos específicos, descritos na tabela de temporalidade e destinação como, por exemplo, \"cinco anos a contar da data de aprovação das contas\", quando não puderem ser detectados automaticamente pelo sistema, deverão ser informados ao SIGAD por usuário autorizado.",
    "Atendido",
...
cruzamentoRequisitos["1.2.9"] = criarRequisito(
    ...
    "É altamente desejável que um SIGAD seja capaz de importar e exportar total ou parcialmente uma tabela de temporalidade e destinação de documento. Ver Organização dos documentos arquivísticos3 – Interoperabilidade",
    "Atendido",
...
cruzamentoRequisitos["2.1.1"] = criarRequisito(
    "2.1.1",
    "Funções de captura",
    "A captura tem que garantir a execução das seguintes funções:\n• registrar e gerenciar todos os documentos não digitais;\n• registrar e gerenciar todos os documentos digitais ou híbridos, independentemente do contexto tecnológico;\n• classificar todos os documentos de acordo com o plano ou código de classificação;\n• controlar e validar a introdução de metadados.",
    "Atendido",
...
cruzamentoRequisitos["2.1.19"] = criarRequisito(
    ...
    "No caso de documentos constituídos por mais de um componente digital, o SIGAD tem que:\n• tratar o documento como uma unidade indivisível, assegurando a relação entre os componentes digitais;\n• preservar a integridade do documento, mantendo a relação entre os componentes digitais;\n• garantir a integridade do documento quando de sua recuperação, visualização e gestão posteriores;\n• gerenciar a destinação de todos os componentes digitais que compõem o documento como uma unidade indivisível.",
    "Atendido",
...
cruzamentoRequisitos["4.2.6"] = criarRequisito(
    ...
    "Um SIGAD tem que permitir que um documento ou dossiê/processo possa ser recuperado por meio de todas as formas de identificação implementadas, incluindo, no mínimo:\n• identificador;\n• título;\n• assunto;\n• datas;\n• interessado;\n• autor/redator/originador;\n• classificação de acordo com plano ou código de classificação.",
    "Atendido",
...
cruzamentoRequisitos["7.2.1"] = criarRequisito(
    ...
    "Para implementar o controle de acesso, um SIGAD tem que manter pelo menos os seguintes atributos dos usuários, de acordo com a política de segurança:\n• identificador do usuário;\n• autorizações de acesso;\n• credenciais de autenticação. Senha, crachá, chave criptográfica, token USB, smartcard, biometria (de impressão digital, de retina etc.) são exemplos de credenciais de autenticação.",
    "Atendido",
...
cruzamentoRequisitos["7.6.3"] = criarRequisito(
    ...
    "Um SIGAD, no processo de verificação do carimbo digital do tempo, tem que ser capaz de registrar, nos metadados do documento, o seguinte:\n• validade do carimbo digital do tempo;\n• registro da verificação do carimbo digital do tempo;\n• data e hora em que ocorreu a verificação.",
    "Não Avaliado",
    "Requisito não avaliado por depender de etapa posterior do projeto.",
    "e-ARQ Obrigatório",
    "7",
...
cruzamentoRequisitos["7.10.3"] = criarRequisito(
    ...
    "A função de acompanhamento de mudança de suporte ou de local tem que registrar metadados que incluam:\n• identificador do documento atribuído pelo SIGAD;\n• localização atual e localizações anteriores (definidas pelo usuário);\n• data e hora do envio/deslocamento;\n• data e hora da recepção no novo local;\n• destinatário;\n• usuário responsável pela mudança de suporte ou de local (sempre que for adequado);\n• método da mudança de suporte ou de local.",
    "Atendido",
...
// ============================================================
// Organização dos documentos arquivísticos0 - ADMINISTRAÇÃO DO SISTEMA
// ============================================================
...
// ============================================================
// Organização dos documentos arquivísticos1 - ASPECTOS LEGAIS
// ============================================================
...
// ============================================================
// Organização dos documentos arquivísticos2 - USABILIDADE
// ============================================================
...
// ============================================================
// Organização dos documentos arquivísticos3 - INTEROPERABILIDADE
// ============================================================
...
// ============================================================
// Organização dos documentos arquivísticos4 - DISPONIBILIDADE
// ============================================================
...
// ============================================================
// Organização dos documentos arquivísticos5 - ESCALABILIDADE
// ============================================================
