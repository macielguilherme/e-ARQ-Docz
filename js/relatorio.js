...
// TODOS OS RELATÓRIOS ABREM E IMPRIMEM AUTOMATICAMENTE
// ============================================================

console.log('Modulo de relatorios carregado.');

// ============================================================
// CSS COMPLETO PARA PDFs - Garante que os PDFs fiquem bonitos
// ============================================================
...
<style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    /* Impede quebras de página ruins */
...
// ============================================================
// FUNÇÃO AUXILIAR - GERA PDF A PARTIR DE HTML (VERSÃO MELHORADA)
// ============================================================
...
// ============================================================
// RELATÓRIO DE CONFORMIDADE (Abre e imprime)
// ============================================================
...
function exportarPDFViaPrint() {
    ...
    <body>
        <div class="header">
            ...
            <div class="meta">Data: 21 de agosto de 2026 · <span class="badge">${stats.conformidadeGeral}% Conformidade Geral</span></div>
        </div>
...
// ============================================================
// RELATÓRIO DE PENDÊNCIAS (Abre e imprime)
// ============================================================
...
function exportarPendenciasPDF() {
    ...
    <body>
        <div class="header">
            ...
            <div class="subtitle">DocZ - Sistema de Gestão Arquivística</div>
            <div class="meta">Data: 21 de agosto de 2026 · Total de Pendências: ${pendentes.length}</div>
        </div>
...
// ============================================================
// RESUMO EXECUTIVO (Abre e imprime)
// ============================================================
...
// ============================================================
// RELATÓRIO EM HTML (VISUALIZAÇÃO)
// ============================================================
...
function exportarHTML() {
    ...
    <body>
        <div class="header">
            ...
            <div class="date">Data da Avaliacao: 21 de agosto de 2026</div>
            <div class="meta">
    ...
    html += `
        ...
        <div class="footer">
            ...
            <p>Data da Avaliacao: 21 de agosto de 2026</p>
        </div>
    </body>
    </html>`;
...
function exportarRelatorioCapitulo(capituloKey) {
    ...
    relatorio += `========================================\n\n`;
    relatorio += `Data de Geracao: ${new Date().toLocaleString('pt-BR')}\n`;
    relatorio += `Data da Avaliacao: 21 de agosto de 2026\n\n`;
    ...
    relatorio += `Nao Atendidos: ${naoAtendidos}\n`;
    relatorio += `Nao Avaliados: ${naoAvaliados}\n`;
...
// ============================================================
// EXPORTAÇÃO DE RELATÓRIO COMPLETO (Todos os PDFs)
// ============================================================
...
console.log('  - exportarPDFViaPrint() - Relatorio de Conformidade (abre e imprime)');
console.log('  - exportarPendenciasPDF() - Relatorio de Pendencias (abre e imprime)');
console.log('  - exportarResumoPDF() - Resumo Executivo (abre e imprime)');
